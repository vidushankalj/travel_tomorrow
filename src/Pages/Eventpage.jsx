...
function Eventpage() {
  return (
    <>
      ...
      <Pageshero bgVideo={HotelVideo} title={"Celebrating Cultural Heritage: Special Events in Srilanka"} message={"Explore the essence of Sri Lanka through its lively special events. From age-old festivals to modern showcases, there's something for everyone. Dive into the music, taste the flavors, and embrace the traditions that make our country unique. Come celebrate with us and experience the true spirit of Sri Lanka."}/>
